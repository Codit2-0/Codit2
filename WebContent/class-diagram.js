d3.classDiagram = (function() {
  ...
  */}
  // creazione contenitore per intera classe
  function createClasses(classes) {
    ...
    // rettangolo contenente l'intestazione
...
//        'transform':'rotate(45)'
    ...
    // rettangolo contenente gli attributi [POSIZIONE]
    ...
    // rettangolo contenente gli attributi [BORDO]
    ...
    // rettangolo contente i metodi [NON SERVE]
  ...
  function createRel(relations){

	    var g = svg.selectAll('g.class')
	      .data(relations).enter().append('g')
	      .attr({
	        id: function(d) { return d.classname + 'Class'; },
	        'class': 'relation',
	        transform: function(d) {
