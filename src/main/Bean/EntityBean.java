...
public class EntityBean {
   ...
   * @param name Nome dell'entit�
   * @param attribute Lista degli attributi
   * @param x Coordinata x dell'entit�
   * @param y Coordinata y dell'entit�
   * @param attributePosX Lista delle coordinate x degli attributi dell'entit�
   * @param attributePosY Lista delle coordinate y degli attributi dell'entit�
   */
